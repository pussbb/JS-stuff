...
');
  ...
  CalendarDayView = (function(_super) {
    ...
    CalendarDayView.prototype.eventsForDayInDayTemplate = eventsForDayInDayTemplate;
    ...
    CalendarDayView.prototype.renderEvents = function() {
      var day, dayEvents;
      day = moment($('table:first', this.$el).data('day')).format('YYYY-MM-DD');
      dayEvents = this.parent.collection.where({
        '_date': day
      });
      if (!dayEvents.length) {
        return;
      }
      return $('table td[class!="time"]:first', this.$el).append(this.eventsForDayInDayTemplate({
        events: dayEvents
      }));
    };
  ...
  CalendarMonthView = (function(_super) {
    ...
    CalendarMonthView.prototype.eventsForDayInMonthTemplate = eventsForDayInMonthTemplate;
    ...
    CalendarMonthView.prototype.renderEvents = function() {
      ...
      self = this;
      return $('table td[data-day]', this.$el).each(function() {
        var $el, day, dayEvents;
        $el = $(this);
        ...
        return $el.append(self.eventsForDayInMonthTemplate({
          events: dayEvents
        }));
      });
    };
    ...
    CalendarMonthView.prototype._day_event_click_hanlder = function(e) {
  ...
  CalendarWeekView = (function(_super) {
    ...
    CalendarWeekView.prototype.eventsForDayInWeekTemplate = eventsForDayInWeekTemplate;
    ...
    CalendarWeekView.prototype.renderEvents = function() {
      var events, self;
      events = this.parent.collection.groupBy('_date');
      self = this;
      return $('table th[data-day]', this.$el).each(function() {
        var $el, $td, day, dayEvents;
        $el = $(this);
        day = moment($el.data('day')).format('YYYY-MM-DD');
        dayEvents = events[day] || [];
        if (!dayEvents.length) {
        ...
        return $td.append(self.eventsForDayInWeekTemplate({
          events: dayEvents
        }));
      });
    };
  ...
  CalendarDayEvent = (function(_super) {
    ...
    CalendarDayEvent.prototype.initialize = function() {
      this.set('_date', moment(this.get('event_date')).format('YYYY-MM-DD'));
      return this;
    };

    CalendarDayEvent.prototype.getTitle = function() {
